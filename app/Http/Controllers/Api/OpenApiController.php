...
class OpenApiController
{
    ...
    private function schemas(): array
    {
        ...
        return [
            ...
            'UpdateClassRequest' => ['type' => 'object', 'properties' => ['name' => $string(), 'description' => $string(), 'teacher_name' => $string(), 'status' => ['type' => 'string', 'enum' => ['draft', 'active', 'inactive', 'completed']], 'start_date' => ['type' => 'string', 'format' => 'date'], 'end_date' => ['type' => 'string', 'format' => 'date'], 'day_of_week' => ['type' => 'integer', 'minimum' => 0, 'maximum' => 6, 'description' => 'Also updates the class primary schedule', 'example' => 1], 'start_time' => ['type' => 'string', 'format' => 'HH:MM', 'description' => 'Also updates the class primary schedule', 'example' => '10:00'], 'recurrence_type' => ['type' => 'string', 'enum' => ['weekly', 'fortnightly', 'monthly'], 'description' => 'Also updates the class primary schedule and payment frequency'], 'payment_amount' => ['type' => 'number', 'format' => 'double', 'minimum' => 0, 'description' => 'Also updates the payment setting\'s required amount']]],
