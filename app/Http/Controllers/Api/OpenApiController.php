...
class OpenApiController
{
    ...
    private function schemas(): array
    {
        ...
        return [
            ...
            'StoreClassRequest' => ['type' => 'object', 'required' => ['name', 'teacher_name', 'day_of_week', 'start_time', 'recurrence_type', 'payment_amount'], 'properties' => ['name' => $string('e.g. Quran Class'), 'description' => $string(), 'teacher_name' => $string('e.g. Cikgu Ahmad'), 'status' => ['type' => 'string', 'enum' => ['draft', 'active', 'inactive', 'completed']], 'start_date' => ['type' => 'string', 'format' => 'date'], 'end_date' => ['type' => 'string', 'format' => 'date'], 'day_of_week' => ['type' => 'integer', 'minimum' => 0, 'maximum' => 6, 'description' => '0 = Sunday, 1 = Monday, ... 6 = Saturday', 'example' => 1], 'start_time' => ['type' => 'string', 'format' => 'HH:MM', 'example' => '10:00'], 'recurrence_type' => ['type' => 'string', 'enum' => ['weekly', 'fortnightly', 'monthly'], 'description' => 'Also used as the initial payment frequency'], 'payment_amount' => ['type' => 'number', 'format' => 'double', 'minimum' => 0, 'description' => 'Required payment amount in MYR', 'example' => 50.00]]],
